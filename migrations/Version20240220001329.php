 ...
 */
final class Version20240220001329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pass (id_pass INT AUTO_INCREMENT NOT NULL, prix_pass INT NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id_pass)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
